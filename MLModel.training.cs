...
namespace ProiectBigData
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\Tudor\Downloads\archive\Symptom2Disease.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"column1", @"column1")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"column1",@"text"}))      
